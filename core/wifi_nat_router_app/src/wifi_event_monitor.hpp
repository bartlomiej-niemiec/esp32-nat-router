...
class WifiEventMonitor
{
    public:
        ...
        using ListenerFunction = std::function<void(WifiNatRouter::
...
EventListener
        {
                public:
                    ...
                    void Callback(WifiNatRouter::
WifiNatRouterState event) override
                    {
    ...
    static constexpr uint32_t WIFI_NAT_ROUTER_QUEUE_SIZE = 16;
    WifiEventDispatcher * m_WifiEventDispatcher;
    QueueHandle_t m_WifiNatRouterEventQueue;
